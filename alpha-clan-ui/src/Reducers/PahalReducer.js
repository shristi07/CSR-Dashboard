...
const initState = {
  ...
  volunteerData: [
    ...
    },
    {
      ...
      summary:
        "Team PAHAL along with Newers aiming to visit the 'Guru Vishram Vridh Ashram' and spend a few hours with around 110 elderly people. Join hands in chatting with them, indulging in some activities and sharing a few laughs.",
      contact: { mail: "naman.goel@gmail.com", name: "Naman Goel" },
      volunteer_before: "04-04-2022",
      starts: "7-04-2022",
    },
  ...
  fundraiserData: [
    {
      funds_for: "John Doe",
      comment:
        "We lost one of our colleagues, Jane Doe in March 2022 due to a cardiac arrest. While we cannot make up for the family's loss, we can still try to extend as much support as possible.To do so, we would encourage each Newer to contribute a portion of their monthly fixed salary",
      fund_aim: "3,00,000",
      collected: "1,90,00",
